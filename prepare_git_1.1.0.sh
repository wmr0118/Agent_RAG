...
echo ""
echo "下一步："
echo "1. 推送分支到GitHub: git push origin refs/heads/v1.1.0:refs/heads/v1.1.0"
echo "2. 推送tag到GitHub: git push origin refs/tags/v1.1.0"
echo ""
echo "或者使用以下命令（推荐）："
echo "  git push origin v1.1.0:refs/heads/v1.1.0  # 推送分支"
echo "  git push origin refs/tags/v1.1.0          # 推送tag"
echo ""
echo "3. 如果需要合并到main:"
echo "  git checkout main"
echo "  git merge v1.1.0"
